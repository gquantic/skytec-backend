...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Нижеприведенные строки языка содержат стандартные сообщения об ошибках, используемые
    | классом валидатора. Некоторые из этих правил имеют несколько версий,
    | такие как правила размера. Вы можете настроить каждое из этих сообщений здесь.
    |
    */
    ...
    'min' => [
        ...
        'file' => 'Поле :attribute должно быть по крайней мере :min килобайт.',
        'numeric' => 'Поле :attribute должно быть по крайней мере :min.',
        'string' => 'Поле :attribute должно содержать по крайней мере :min символов.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Здесь вы можете указать пользовательские сообщения о валидации для атрибутов с использованием
    | соглашения "attribute.rule", чтобы называть строки. Это помогает быстро
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Нижеприведенные строки языка используются для замены заполнителя атрибута
    | на что-то более понятное, такое как "Адрес электронной почты" вместо "email".
    | Это просто помогает сделать наше сообщение более выразительным.
    |
    */
